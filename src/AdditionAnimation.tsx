	...
	return (
		...
		>
			...
			<motion.button
				...
				onClick={onComplete}
				className="mt-8 px-8 py-3 bg-blue-500 hover:bg-blue-400 text-white rounded-full font-bold text-xl shadow-lg active:scale-95 transition-all flex items-center gap-2"
			>
				Continue
